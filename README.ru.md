...
Таксономическая и ранжированная по цитируемости карта исследований по инвестициям в акции и AI-трейдингу за 2000-2026 годы.
...
Примечание: этот локализованный README заново создается из текущего набора выбранных работ. Названия статей, авторы, URL, бейджи, пути к файлам и идентификаторы сохранены для воспроизводимости.

Сгенерировано 2026-06-27 на основе бесплатных публичных метаданных Semantic Scholar. Эта версия проверяет до 1,000 кандидатных работ по инвестициям в акции и AI-трейдингу на каждый год публикации за 2000-2026, хранит аудированный пул из 27,000 записей, выбирает 100 наиболее цитируемых работ за каждый год (2,700 выбранных работ) и реорганизует их по исследовательской таксономии.

## Ссылки проекта

- Интерактивный сайт: https://honggi82.github.io/awesome-trade/
- Выбранный набор данных: `data/papers_2000_2026.csv`
- Таксономический набор с идеями, сильными сторонами и ограничениями по каждой работе: `data/papers_taxonomy_2000_2026.csv`
- Предварительно рассчитанный анализ периодов: `data/period_analysis_2000_2026.json`
- Пул кандидатов: `data/candidates_top1000_2000_2026.csv`
- Черновик обзора на английском: `paper/review_en.html`, `paper/review_en.docx`
- Черновик обзора на корейском: `paper/review_ko.html`

## Соглашение по ключевым словам

Эти бейджи задают keyword tags для инвестиций в акции и AI-трейдинга, используемые для чтения и расширения коллекции.
...
- **Всего выбранных работ**: 2,700 работ
- **Аудированный пул кандидатов**: 27,000 работ (2000: 1,000, 2001: 1,000, 2002: 1,000, 2003: 1,000, 2004: 1,000, 2005: 1,000, 2006: 1,000, 2007: 1,000, 2008: 1,000, 2009: 1,000, 2010: 1,000, 2011: 1,000, 2012: 1,000, 2013: 1,000, 2014: 1,000, 2015: 1,000, 2016: 1,000, 2017: 1,000, 2018: 1,000, 2019: 1,000, 2020: 1,000, 2021: 1,000, 2022: 1,000, 2023: 1,000, 2024: 1,000, 2025: 1,000, 2026: 1,000)
- **Цитирования в выбранном наборе**: 789,670
- **General Finance, Surveys, and Trading Systems**: 733 работ
- **Risk, Volatility, and Forecast Evaluation**: 429 работ
- **Asset Pricing and Return Predictability**: 335 работ
- **Sentiment, News, and Alternative Data**: 296 работ
- **Portfolio Optimization and Asset Allocation**: 252 работ
- **Deep Learning and Financial Time Series**: 214 работ
- **Reinforcement Learning and Algorithmic Trading**: 182 работ
- **Market Microstructure and High-Frequency Trading**: 153 работ
- **Machine Learning for Stock Prediction**: 71 работ
- **Behavioral Finance and Investor Decision-Making**: 35 работ

## Коллекции по таксономии

### General Finance, Surveys, and Trading Systems

- Выбранные работы: **733**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **238,297**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: General Finance, Surveys, and Trading Systems</strong></summary>
...
- Выбранные работы: **429**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **114,016**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Risk, Volatility, and Forecast Evaluation</strong></summary>
...
- Выбранные работы: **335**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **133,801**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Asset Pricing and Return Predictability</strong></summary>
...
- Выбранные работы: **296**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **75,851**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Sentiment, News, and Alternative Data</strong></summary>
...
- Выбранные работы: **252**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **71,087**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Portfolio Optimization and Asset Allocation</strong></summary>
...
- Выбранные работы: **214**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **45,904**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Deep Learning and Financial Time Series</strong></summary>
...
- Выбранные работы: **182**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **35,817**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Reinforcement Learning and Algorithmic Trading</strong></summary>
...
- Выбранные работы: **153**
- Охваченные годы: **2000-2026**
- Цитирования в выбранном наборе: **47,006**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Market Microstructure and High-Frequency Trading</strong></summary>
...
- Выбранные работы: **71**
- Охваченные годы: **2001-2026**
- Цитирования в выбранном наборе: **18,819**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Machine Learning for Stock Prediction</strong></summary>
...
- Выбранные работы: **35**
- Охваченные годы: **2000-2023**
- Цитирования в выбранном наборе: **9,072**
- Обзор категории:
...
<details>
<summary><strong>Показать репрезентативные работы: Behavioral Finance and Investor Decision-Making</strong></summary>
...
## Годовая сводка выбора

| Год | Записи-кандидаты | Выбранные работы | Цитирования выбранных | Лидирующая работа |
|---:|---:|---:|---:|---|
...
Коллекция использует bulk search Semantic Scholar Academic Graph. Запросы охватывают прогнозирование акций, доходности акций, asset pricing, оптимизацию портфеля, финансовые временные ряды, алгоритмический трейдинг, обучение с подкреплением, sentiment/новости/альтернативные данные, микроструктуру рынка, высокочастотную торговлю, волатильность и риск. Для каждого года с 2000 по 2026 результаты фильтруются по году публикации, проверяются явными выражениями релевантности к инвестициям в акции и AI-трейдингу в метаданных title/abstract/venue, дедуплицируются по DOI, arXiv, PubMed, CorpusId, paperId, затем названию, и сокращаются максимум до 1,000 кандидатов по числу цитирований. Финальный awesome-список выбирает 100 наиболее цитируемых работ в каждом году; влиятельные цитирования и детерминированный metadata-importance score сохраняются как сигналы для тай-брейков и аудита.

Таксономия, ключевые идеи, сильные стороны, ограничения, method tags и keyword tags генерируются детерминированно из публичных метаданных и правил предметной области. Платные API, платные LLM, платный перевод и платные вычисления не использовались.

## Ограничения

- Это карта цитирований на основе метаданных, а не полный систематический обзор каждого PDF.
- Число цитирований является сигналом влияния, а не инвестиционным советом или доказательством прибыльности реальной торговли.
- Метаданные Semantic Scholar могут не содержать venue, abstract, PDF или influential citations для некоторых записей.
- Работы 2026 года структурно находятся в невыгодном положении, поскольку год неполный, а накопление цитирований на 2026-06-27 еще незрелое.
- Исследования инвестиций в акции особенно чувствительны к транзакционным издержкам, survivorship bias, look-ahead bias, market impact и смене режимов; это требует проверки на уровне полной статьи и данных.

## Благодарности

Этот репозиторий и интерактивный сайт созданы с благодарностью к [jehyunlee/paper-curation](https://github.com/jehyunlee/paper-curation). Его workflow и структура репозитория повлияли на подход к этой таксономической карте исследований, ранжированной по цитированиям.

## Лицензия

Текст и курирование метаданных распространяются по CC-BY-4.0. Исходные метаданные статей принадлежат оригинальным источникам.
