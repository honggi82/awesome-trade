...
2000년부터 2026년까지의 주식 투자 및 AI 기반 트레이딩 연구를 분류 우선 방식으로 정리하고 인용수 기준으로 순위화한 지도입니다.
...
참고: 이 현지화 README는 현재 선정 논문 데이터셋에서 재생성되었습니다. 논문 제목, 저자명, URL, 배지, 파일 경로, 식별자는 재현성을 위해 원문 그대로 유지했습니다.

무료 공개 Semantic Scholar 메타데이터를 기준으로 2026-06-27에 생성했습니다. 이 판은 2000-2026 기간의 각 출판연도마다 주식 투자 및 AI 트레이딩 후보 논문을 최대 1,000편 조사하고, 감사된 후보 풀 27,000건을 유지하며, 매년 인용수 상위 100편(2,700편 선정)을 골라 연구 분류 체계별로 재구성합니다.

## 프로젝트 링크

- 인터랙티브 웹사이트: https://honggi82.github.io/awesome-trade/
- 선정 데이터셋: `data/papers_2000_2026.csv`
- 논문별 아이디어, 강점, 한계가 포함된 분류 데이터셋: `data/papers_taxonomy_2000_2026.csv`
- 사전 계산된 기간 분석: `data/period_analysis_2000_2026.json`
- 후보 풀: `data/candidates_top1000_2000_2026.csv`
- 영어 리뷰 초안: `paper/review_en.html`, `paper/review_en.docx`
- 한국어 리뷰 초안: `paper/review_ko.html`

## 키워드 규칙

이 배지는 컬렉션을 읽고 확장할 때 사용하는 주식 투자 및 AI 트레이딩 키워드 태그를 정의합니다.

- ![stock-prediction](https://img.shields.io/badge/keyword-stock--prediction-0f766e) **stock-prediction**: 주가, 수익률, 방향성, 추세, 시장지수 예측과 forecasting.
- ![machine-learning](https://img.shields.io/badge/keyword-machine--learning-475569) **machine-learning**: SVM, 트리, 부스팅, 랜덤 포레스트, 커널, 데이터마이닝 등 전통적 ML 기반 시장 분석.
- ![deep-learning](https://img.shields.io/badge/keyword-deep--learning-2563eb) **deep-learning**: LSTM/GRU/CNN, attention, transformer, 표현학습 기반 금융 시계열 모델.
- ![ai-based-trade](https://img.shields.io/badge/keyword-ai--based--trade-16a34a) **ai-based-trade**: AI/ML 예측 모델, NLP/LLM, 자동화 전략을 활용한 주식 거래와 투자 신호.
- ![portfolio](https://img.shields.io/badge/keyword-portfolio-7c2d12) **portfolio**: 포트폴리오 최적화, 자산배분, 포트폴리오 선택, 리스크 패리티, 리밸런싱.
- ![reinforcement-trading](https://img.shields.io/badge/keyword-reinforcement--trading-dc2626) **reinforcement-trading**: 강화학습, 알고리즘 트레이딩, 실행, market making, 백테스트된 거래 전략.
- ![sentiment-altdata](https://img.shields.io/badge/keyword-sentiment--altdata-f59e0b) **sentiment-altdata**: 뉴스, 소셜미디어, NLP, LLM, 실적발표, 대체데이터 기반 투자 신호.
- ![high-frequency](https://img.shields.io/badge/keyword-high--frequency-0891b2) **high-frequency**: 시장 미시구조, limit order book, order flow, 유동성, 고빈도 거래.
- ![risk-volatility](https://img.shields.io/badge/keyword-risk--volatility-be123c) **risk-volatility**: 변동성 예측, VaR, drawdown, tail risk, stress test, 예측 평가.
- ![asset-pricing](https://img.shields.io/badge/keyword-asset--pricing-4f46e5) **asset-pricing**: 자산가격결정, 주식 팩터, anomaly, 수익률 예측성, 횡단면 주식 수익률.
- ![behavioral-finance](https://img.shields.io/badge/keyword-behavioral--finance-a855f7) **behavioral-finance**: 투자자 심리, attention, 행동 편향, 시장 효율성, 의사결정.
...
- **전체 선정 논문**: 2,700 편
- **감사된 후보 풀**: 27,000 편 (2000: 1,000, 2001: 1,000, 2002: 1,000, 2003: 1,000, 2004: 1,000, 2005: 1,000, 2006: 1,000, 2007: 1,000, 2008: 1,000, 2009: 1,000, 2010: 1,000, 2011: 1,000, 2012: 1,000, 2013: 1,000, 2014: 1,000, 2015: 1,000, 2016: 1,000, 2017: 1,000, 2018: 1,000, 2019: 1,000, 2020: 1,000, 2021: 1,000, 2022: 1,000, 2023: 1,000, 2024: 1,000, 2025: 1,000, 2026: 1,000)
- **선정 세트의 총 인용수**: 789,670
- **General Finance, Surveys, and Trading Systems**: 733 편
- **Risk, Volatility, and Forecast Evaluation**: 429 편
- **Asset Pricing and Return Predictability**: 335 편
- **Sentiment, News, and Alternative Data**: 296 편
- **Portfolio Optimization and Asset Allocation**: 252 편
- **Deep Learning and Financial Time Series**: 214 편
- **Reinforcement Learning and Algorithmic Trading**: 182 편
- **Market Microstructure and High-Frequency Trading**: 153 편
- **Machine Learning for Stock Prediction**: 71 편
- **Behavioral Finance and Investor Decision-Making**: 35 편
...
<details>
<summary><strong>대표 논문 보기: General Finance, Surveys, and Trading Systems</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Risk, Volatility, and Forecast Evaluation</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Asset Pricing and Return Predictability</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Sentiment, News, and Alternative Data</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Portfolio Optimization and Asset Allocation</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Deep Learning and Financial Time Series</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Reinforcement Learning and Algorithmic Trading</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Market Microstructure and High-Frequency Trading</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Machine Learning for Stock Prediction</strong></summary>
...
<details>
<summary><strong>대표 논문 보기: Behavioral Finance and Investor Decision-Making</strong></summary>
...
| 연도 | 후보 기록 | 선정 논문 | 선정 논문 인용수 | 최상위 선정 논문 |
|---:|---:|---:|---:|---|
...
이 컬렉션은 Semantic Scholar Academic Graph bulk search를 사용합니다. 쿼리는 주가 예측, 주식 수익률, 자산가격결정, 포트폴리오 최적화, 금융 시계열, 알고리즘 트레이딩, 강화학습, 감성/뉴스/대체데이터, 시장 미시구조, 고빈도 거래, 변동성, 리스크 주제를 포괄합니다. 2000년부터 2026년까지 각 연도 결과를 출판연도로 필터링하고, 제목/초록/venue 메타데이터에서 주식 투자 및 AI 트레이딩 관련 명시적 표현으로 선별한 뒤, DOI, arXiv, PubMed, CorpusId, paperId, 제목 순으로 중복을 제거하고 인용수 기준 최대 1,000편의 후보로 축소합니다. 최종 awesome 목록은 각 출판연도 안에서 인용수 상위 100편을 선정하며, 영향력 인용수와 결정적 메타데이터 중요도 점수는 동률 처리 및 감사 신호로 보존합니다.

분류 체계, 핵심 아이디어, 강점, 한계, 방법 태그, 키워드 태그는 공개 메타데이터와 규칙 기반 도메인 규약에서 결정적으로 생성됩니다. 유료 API, 유료 LLM, 유료 번역, 유료 컴퓨팅은 사용하지 않았습니다.

## 한계

- 이 자료는 메타데이터 기반 인용 지도이며, 모든 PDF를 읽은 완전한 체계적 문헌고찰은 아닙니다.
- 인용수는 영향력 신호일 뿐이며 투자 조언이나 실제 거래 수익성의 증거가 아닙니다.
- Semantic Scholar 메타데이터에는 일부 레코드의 venue, 초록, PDF, 영향력 인용수가 누락될 수 있습니다.
- 2026년 논문은 연도가 아직 진행 중이고 2026-06-27 기준 인용 축적이 충분히 성숙하지 않아 구조적으로 불리합니다.
- 주식 투자 연구는 거래비용, 생존편향, look-ahead bias, 시장충격, regime change에 특히 민감하므로 논문 전문과 데이터 수준 검토가 필요합니다.

## 감사의 말

이 저장소와 인터랙티브 사이트는 [jehyunlee/paper-curation](https://github.com/jehyunlee/paper-curation)에 대한 감사와 함께 만들었습니다. 해당 paper-curation 워크플로와 저장소 구성이 이곳의 분류 우선, 인용 순위 기반 연구 지도 접근에 참고가 되었습니다.

## 라이선스

텍스트와 메타데이터 큐레이션은 CC-BY-4.0을 따릅니다. 원천 논문 메타데이터는 각 원본 출처에 속합니다.
