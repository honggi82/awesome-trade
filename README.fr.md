...
Une carte de recherche sur l'investissement actions et le trading piloté par l'IA, structurée par taxonomie et classée par citations, de 2000 à 2026.
...
Note : ce README localisé est régénéré à partir du jeu actuel d'articles sélectionnés. Les titres d'articles, noms d'auteurs, URL, badges, chemins de fichiers et identifiants sont conservés pour la reproductibilité.

Généré le 2026-06-27 à partir de métadonnées publiques gratuites de Semantic Scholar. Cette édition examine jusqu'à 1,000 articles candidats sur l'investissement actions et le trading par IA par année de publication pour 2000-2026, conserve un vivier audité de 27,000 enregistrements, sélectionne les 100 articles les plus cités de chaque année (2,700 articles sélectionnés) et les réorganise par taxonomie de recherche.

## Liens du projet

- Site web interactif : https://honggi82.github.io/awesome-trade/
- Jeu de données sélectionné : `data/papers_2000_2026.csv`
- Jeu de taxonomie avec idées, forces et limites au niveau des articles : `data/papers_taxonomy_2000_2026.csv`
- Analyse de période précalculée : `data/period_analysis_2000_2026.json`
- Vivier de candidats : `data/candidates_top1000_2000_2026.csv`
- Brouillon de revue en anglais : `paper/review_en.html`, `paper/review_en.docx`
- Brouillon de revue en coréen : `paper/review_ko.html`

## Convention des mots-clés

Ces badges définissent les tags de mots-clés liés à l'investissement actions et au trading IA utilisés pour lire et étendre cette collection.
...
- **Total d'articles sélectionnés**: 2,700 articles
- **Vivier de candidats audité**: 27,000 articles (2000: 1,000, 2001: 1,000, 2002: 1,000, 2003: 1,000, 2004: 1,000, 2005: 1,000, 2006: 1,000, 2007: 1,000, 2008: 1,000, 2009: 1,000, 2010: 1,000, 2011: 1,000, 2012: 1,000, 2013: 1,000, 2014: 1,000, 2015: 1,000, 2016: 1,000, 2017: 1,000, 2018: 1,000, 2019: 1,000, 2020: 1,000, 2021: 1,000, 2022: 1,000, 2023: 1,000, 2024: 1,000, 2025: 1,000, 2026: 1,000)
- **Citations dans l'ensemble sélectionné**: 789,670
- **General Finance, Surveys, and Trading Systems**: 733 articles
- **Risk, Volatility, and Forecast Evaluation**: 429 articles
- **Asset Pricing and Return Predictability**: 335 articles
- **Sentiment, News, and Alternative Data**: 296 articles
- **Portfolio Optimization and Asset Allocation**: 252 articles
- **Deep Learning and Financial Time Series**: 214 articles
- **Reinforcement Learning and Algorithmic Trading**: 182 articles
- **Market Microstructure and High-Frequency Trading**: 153 articles
- **Machine Learning for Stock Prediction**: 71 articles
- **Behavioral Finance and Investor Decision-Making**: 35 articles

## Collections taxonomiques

### General Finance, Surveys, and Trading Systems

- Articles sélectionnés : **733**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **238,297**
...
<details>
<summary><strong>Afficher les articles représentatifs pour General Finance, Surveys, and Trading Systems</strong></summary>
...
- Articles sélectionnés : **429**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **114,016**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Risk, Volatility, and Forecast Evaluation</strong></summary>
...
- Articles sélectionnés : **335**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **133,801**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Asset Pricing and Return Predictability</strong></summary>
...
- Articles sélectionnés : **296**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **75,851**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Sentiment, News, and Alternative Data</strong></summary>
...
- Articles sélectionnés : **252**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **71,087**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Portfolio Optimization and Asset Allocation</strong></summary>
...
- Articles sélectionnés : **214**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **45,904**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Deep Learning and Financial Time Series</strong></summary>
...
- Articles sélectionnés : **182**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **35,817**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Reinforcement Learning and Algorithmic Trading</strong></summary>
...
- Articles sélectionnés : **153**
- Années couvertes : **2000-2026**
- Citations dans l'ensemble sélectionné : **47,006**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Market Microstructure and High-Frequency Trading</strong></summary>
...
- Articles sélectionnés : **71**
- Années couvertes : **2001-2026**
- Citations dans l'ensemble sélectionné : **18,819**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Machine Learning for Stock Prediction</strong></summary>
...
- Articles sélectionnés : **35**
- Années couvertes : **2000-2023**
- Citations dans l'ensemble sélectionné : **9,072**
- Aperçu de la catégorie :
...
<details>
<summary><strong>Afficher les articles représentatifs pour Behavioral Finance and Investor Decision-Making</strong></summary>
...
## Résumé annuel de sélection

| Année | Candidats | Articles sélectionnés | Citations sélectionnées | Article principal |
|---:|---:|---:|---:|---|
...
La collection utilise la recherche en masse du Semantic Scholar Academic Graph. Les requêtes couvrent la prédiction boursière, les rendements actions, l'asset pricing, l'optimisation de portefeuille, les séries temporelles financières, le trading algorithmique, l'apprentissage par renforcement, le sentiment/les nouvelles/les données alternatives, la microstructure de marché, le trading haute fréquence, la volatilité et les thèmes de risque. Pour chaque année de 2000 à 2026, les résultats sont filtrés par année de publication, examinés avec des expressions explicites de pertinence pour l'investissement actions et le trading IA dans les métadonnées de titre, résumé et venue, dédupliqués par DOI, arXiv, PubMed, CorpusId, paperId puis titre, et réduits à au plus 1,000 candidats par nombre de citations. La liste awesome finale sélectionne les 100 articles les plus cités dans chaque année; les citations influentes et un score déterministe d'importance des métadonnées sont conservés comme signaux de départage et d'audit.

La taxonomie, les idées clés, les forces, les limites, les tags de méthode et les tags de mots-clés sont générés de manière déterministe à partir de métadonnées publiques et de conventions de domaine fondées sur des règles. Aucune API payante, aucun LLM payant, aucune traduction payante ni aucun calcul payant n'a été utilisé.

## Limites

- Il s'agit d'une carte de citations pilotée par les métadonnées, et non d'une revue systématique complète de chaque PDF.
- Le nombre de citations est un signal d'influence, pas un conseil d'investissement ni une preuve de rentabilité en trading réel.
- Les métadonnées Semantic Scholar peuvent omettre venues, résumés, PDFs ou citations influentes pour certains enregistrements.
- Les articles de 2026 sont structurellement désavantagés car l'année est partielle et l'accumulation de citations reste immature au 2026-06-27.
- La recherche sur l'investissement actions est particulièrement sensible aux coûts de transaction, au biais de survie, au look-ahead bias, à l'impact de marché et aux changements de régime; ces points exigent une revue au niveau des articles et des données.

## Remerciements

Ce dépôt et le site interactif ont été créés avec reconnaissance envers [jehyunlee/paper-curation](https://github.com/jehyunlee/paper-curation). Son workflow de curation d'articles et son organisation de dépôt ont inspiré l'approche utilisée ici.

## Licence

CC-BY-4.0 pour le texte et la curation des métadonnées. Les métadonnées amont appartiennent aux sources originales.
